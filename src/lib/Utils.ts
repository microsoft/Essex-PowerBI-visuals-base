 ...
 */
export function hasDataChanged<T>(newData: T[], oldData: T[], equality: (a: T, b: T) => boolean) {
    "use strict";
...
export function listDiff<M>(existingItems: M[], newItems: M[], differ: IDiffProcessor<M>) {
    "use strict";
 ...
 */
 export const Utils = { // tslint:disable-line
  hasDataChanged,
  listDiff,
 };
