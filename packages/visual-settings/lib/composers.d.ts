...
import { IColoredObject } from "@essex/visual-utils";
/**
 ...
 */
export declare function coloredObjectInstanceComposer(defaultColor?: IDefaultInstanceColor): ISettingsComposer<IColoredObject | IColoredObject[]>;
/**
